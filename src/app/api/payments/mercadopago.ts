...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data: { id }, type = "payment" } = paymentSchema.parse(body);
    ...
    try {
      ...
      // Si también necesitas llamar a buyCourse en algunos casos, puedes añadir la lógica aquí
      // Por ejemplo, si hay un tipo específico de item o metadata que indica que es un curso
